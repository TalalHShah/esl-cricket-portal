...
class TransferMarketController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $query = Player::with('team')
            ...
            ->when($request->filled('country'), fn ($q) => $q->where('country', 'like', '%' . $request->input('country') . '%'));
        ...
        return view('manager.transfers', compact('listedPlayers', 'myTransfers', 'team', 'roles', 'tiers', 'teams', 'windowOpen', 'sort'));
    }
